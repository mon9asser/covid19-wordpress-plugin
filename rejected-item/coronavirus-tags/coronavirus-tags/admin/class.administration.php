...
if( !class_exists( 'covtags_administration_panel' ) ) {
  ...
  class covtags_administration_panel {
    ...
    public function include_external_files (){
      wp_enqueue_script( 'covtags-admin-scripts', COVTAGS_SRC . 'assets/js/covtags.admin.min.js', array( 'jquery' ), COVTAGS_VER, true );
      wp_enqueue_style( 'covtags-admin-styles', COVTAGS_SRC . 'assets/css/style.admin.min.css', false, COVTAGS_VER, 'all' );
                    ...
                    <div id="covtags-settings" class="block-contents">
                      ...
                      <div class="covtags-contents-body covtags-contents-body-override">
                        ...
                        <div class="eratags-fields">
                          ...
                          <select id="covtags_corona_cacheperiod" class="" name="<?php echo esc_attr( 'covdescperiod' ); ?>">
                            <option <?php $this->selected( 5 ); ?> value="<?php echo esc_attr(5); ?>"><?php echo sprintf( esc_html__( '%1$s Mins', COVTAGS_TEXTDOMAIN ), 5  ); ?></option>
                            <option <?php $this->selected( 10 ); ?> value="<?php echo esc_attr(10); ?>"><?php echo sprintf( esc_html__( '%1$s Mins', COVTAGS_TEXTDOMAIN ), 10  ); ?></option>
                            <option <?php $this->selected( 20 ); ?> value="<?php echo esc_attr(20); ?>"><?php echo sprintf( esc_html__( '%1$s Mins', COVTAGS_TEXTDOMAIN ), 20  ); ?></option>
                            <option <?php $this->selected( 30 ); ?> value="<?php echo esc_attr(30); ?>"><?php echo sprintf( esc_html__( '%1$s Mins', COVTAGS_TEXTDOMAIN ), 30  ); ?></option>
                            <option <?php $this->selected( 60 ); ?> value="<?php echo esc_attr(60); ?>"><?php echo sprintf( esc_html__( '%1$s Mins', COVTAGS_TEXTDOMAIN ), 60  ); ?></option>
                            <option <?php $this->selected( 120 ); ?> value="<?php echo esc_attr(120); ?>"><?php echo sprintf( esc_html__( '%1$s Mins', COVTAGS_TEXTDOMAIN ), 120  ); ?></option>
                            <option <?php $this->selected( 300 ); ?> value="<?php echo esc_attr(300); ?>"><?php echo sprintf( esc_html__( '%1$s Hours', COVTAGS_TEXTDOMAIN ), 5  ); ?></option>
                            <option <?php $this->selected( 1440 ); ?> value="<?php echo esc_attr(1440); ?>"><?php echo sprintf( esc_html__( '%1$s Hours', COVTAGS_TEXTDOMAIN ), 24  ); ?></option>
                          </select>
                        </div>
                          ...
                          <div class="eratags-fields covstags-field-contents">
                            ...
                            <form class="" id="shorcodeform" action="#" method="post">
                                ...
                                <div class="eratags-fields default-section covtags-shortcode-field">
                                  ...
                                  <div class="field-x2">
                                    <select id="<?php echo esc_attr( 'covtags-data-provider' );?>" class="" name="">
                                      <option value="<?php echo esc_attr( 'covtags-all-countries' ); ?>"><?php esc_html_e( 'Countries Datatable', COVTAGS_TEXTDOMAIN ); ?></option>
                                      <option value="<?php echo esc_attr( 'covtags-statistics' ); ?>"><?php esc_html_e( 'World Wide Statistics', COVTAGS_TEXTDOMAIN ); ?></option>
                                      <option value="<?php echo esc_attr( 'covtags-tricker-world-card' ); ?>"><?php esc_html_e( 'Tricker', COVTAGS_TEXTDOMAIN ); ?></option>
                                      <option value="<?php echo esc_attr( 'covtags-status' ); ?>"><?php esc_html_e( 'Cases Card', COVTAGS_TEXTDOMAIN ); ?></option>
                                ...
                                <div data-name="<?php echo esc_attr( 'status_type' ); ?>" class="eratags-fields tble-fields">
                                  <div class="field-x1">
                                    <?php esc_html_e( 'Cases Type', COVTAGS_TEXTDOMAIN ); ?>
                                  </div>
                                  <div class="field-x2">
                                    <ul>
                                      <li>
                                ...
                                <div data-name="<?php echo esc_attr( 'status_type' ); ?>" class="eratags-fields tble-fields">
                              <div class="field-x1">
                                <?php esc_html_e( 'Cases Card Type', COVTAGS_TEXTDOMAIN ); ?>
                              </div>
                              <div class="field-x2">
                                <ul>
                                  <li data-name='<?php echo esc_attr( 'cases-card-active' ); ?>'>
                                    <label class="covtags-radio-handler" for="<?php echo esc_attr( 'cases-card-type-active' ); ?>">
                                      <input id="<?php echo esc_attr( 'cases-card-type-active' ); ?>" type="radio" name="<?php echo esc_attr( 'status_type' ); ?>" value="<?php echo esc_attr( 'active' ); ?>">
                                      <?php esc_html_e( 'Active Cases', COVTAGS_TEXTDOMAIN ); ?>
                                    </label>
                                  </li>

                                  <li data-name='<?php echo esc_attr( 'cases-card-closed' ); ?>'>
                                    <label class="covtags-radio-handler" for="<?php echo esc_attr( 'cases-card-type-closed' ); ?>">
                                      <input id="<?php echo esc_attr( 'cases-card-type-closed' ); ?>" type="radio" name="<?php echo esc_attr( 'status_type' ); ?>" value="<?php echo esc_attr( 'closed' ); ?>">
                                      <?php esc_html_e( 'Closed Cases', COVTAGS_TEXTDOMAIN ); ?>
                                    </label>
                                  </li>
                                </ul>
                              </div>
