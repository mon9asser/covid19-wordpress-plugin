...
if( !class_exists( 'CovTags_Shortcode_Cards' ) ){
  class CovTags_Shortcode_Cards extends CovTags_UI {
    ...
    public function __construct (){
      ...
      #statistics-card
      add_shortcode( 'covtags-statistics', array( $this, 'covtags_live_statistics_card' ) );
      add_shortcode( 'covtags-all-countries', array( $this, 'covtags_table_and_graph' ) );
      //add_shortcode( 'covtags-ticker', array( $this, 'covtags_ticker_bar' ) );
      add_shortcode( 'covtags-status', array( $this, 'covtags_list_shortcode_with_status' ) );
      add_shortcode( 'covtags-map', array( $this, 'covtages_map_countreis_data' ) );
      add_shortcode( 'covtags-tricker-world-card', array( $this, 'covtags_tricker_world_card_data' ) );
    ...
    public function covtags_live_statistics_card ( $atts ){
      ...
      $default_atts = array(
        ...
        'style'         => 'default',
        'country'       => null,
        'inner-spacing' => '20', # For next version
        'rounded'       => '0', # For next version
        'align_text'    => 'yes',
        'icon_flag'     => 'no',
        'dark_mode'     => 'no'
      );
