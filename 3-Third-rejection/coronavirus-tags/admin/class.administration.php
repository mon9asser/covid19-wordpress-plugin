                            ...
                            <form class="" id="shorcodeform" action="#" method="post">
                                ...
                                <div class="eratags-fields default-section covtags-shortcode-field">
                                  ...
                                  <div class="field-x2">
                                    <select id="<?php echo esc_attr( 'covtags-data-provider' );?>" class="" name="">
                                      ...
                                      <option value="<?php echo esc_attr( 'covtags-ticker' ); ?>"><?php esc_html_e( 'Tricker', COVTAGS_TEXTDOMAIN ); ?></option>
                                ...
                                <div data-name="<?php echo esc_attr( 'tricker_speed' ); ?>" class="eratags-fields tble-fields">
                                  ...
                                  <div class="field-x2">
                                    <ul>
                                      <li>
                                        <label class="covtags-radio-handler" for="<?php echo esc_attr( 'ticker-speed-normal' ); ?>">
                                          <input id="<?php echo esc_attr( 'ticker-speed-normal' ); ?>" type="radio" name="<?php echo esc_attr( 'ticker_speed' );?>" value="<?php echo esc_attr( 'normal' ); ?>">
                                          <?php esc_html_e( 'Normal', COVTAGS_TEXTDOMAIN ); ?>
                                        </label>
                                      </li>

                                      <li>
                                        <label class="covtags-radio-handler" for="<?php echo esc_attr( 'ticker-speed-slow' ); ?>">
                                          <input id="<?php echo esc_attr( 'ticker-speed-slow' ); ?>" type="radio" name="<?php echo esc_attr( 'ticker_speed' );?>" value="<?php echo esc_attr( 'slow' ); ?>">
                                          <?php esc_html_e( 'Slow', COVTAGS_TEXTDOMAIN ); ?>
                                        </label>
                                      </li>

                                      <li>
                                        <label class="covtags-radio-handler" for="<?php echo esc_attr( 'ticker-speed-medium' ); ?>">
                                          <input id="<?php echo esc_attr( 'ticker-speed-medium' ); ?>" type="radio" name="<?php echo esc_attr( 'ticker_speed' );?>" value="<?php echo esc_attr( 'medium' ); ?>">
                                          <?php esc_html_e( 'Medium', COVTAGS_TEXTDOMAIN ); ?>
                                        </label>
                                      </li>

                                      <li>
                                        <label class="covtags-radio-handler" for="<?php echo esc_attr( 'ticker-speed-fast' ); ?>">
                                          <input id="<?php echo esc_attr( 'ticker-speed-fast' ); ?>" type="radio" name="<?php echo esc_attr( 'ticker_speed' );?>" value="<?php echo esc_attr( 'fast' ); ?>">
                                ...
                                <!-- tricker_position-->
                                <div data-name="<?php echo esc_attr( 'position' ); ?>" class="eratags-fields tble-fields">
                                  <div class="field-x1">
                                  ...
                                  <div class="field-x2">
                                    <ul>
                                      <li>
                                        <label class="covtags-radio-handler" for="<?php echo esc_attr( 'ticker-position-normal' ); ?>">
                                          <input id="<?php echo esc_attr( 'ticker-position-normal' ); ?>" type="radio" name="<?php echo esc_attr( 'position' );?>" value="<?php echo esc_attr( 'normal' ); ?>">
                                          <?php esc_html_e( 'Normal', COVTAGS_TEXTDOMAIN ); ?>
                                        </label>
                                      </li>

                                      <li>
                                        <label class="covtags-radio-handler" for="<?php echo esc_attr( 'ticker-position-top' ); ?>">
                                          <input id="<?php echo esc_attr( 'ticker-position-top' ); ?>" type="radio" name="<?php echo esc_attr( 'position' );?>" value="<?php echo esc_attr( 'top' ); ?>">
                                          <?php esc_html_e( 'Top', COVTAGS_TEXTDOMAIN ); ?>
                                        </label>
                                      </li>

                                      <li>
                                        <label class="covtags-radio-handler" for="<?php echo esc_attr( 'ticker-position-bottom' ); ?>">
                                          <input id="<?php echo esc_attr( 'ticker-position-bottom' ); ?>" type="radio" name="<?php echo esc_attr( 'position' );?>" value="<?php echo esc_attr( 'bottom' ); ?>">
                                          <?php esc_html_e( 'Bottom', COVTAGS_TEXTDOMAIN ); ?>
                                        </label>
                                      </li>
