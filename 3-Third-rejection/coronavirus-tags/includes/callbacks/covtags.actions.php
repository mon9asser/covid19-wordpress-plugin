...
if( !function_exists( 'covtags_load_external_files' ) ){
  function covtags_load_external_files (){
    ...
    wp_enqueue_style( 'covtags-stylesheets'  , COVTAGS_SRC . 'assets/css/main.styles.min.css', false , COVTAGS_VER , 'all' );
    ...
    wp_enqueue_script( 'covtags-scripts' ,  COVTAGS_SRC . 'assets/js/main.scripts.min.js', array( 'jquery' ) , COVTAGS_VER , false );
