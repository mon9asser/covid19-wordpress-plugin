...
if( !class_exists( 'CovTags_Shortcode_Cards' ) ){
  class CovTags_Shortcode_Cards extends CovTags_UI {
    ...
    public function __construct (){
      ...
      add_shortcode( 'covtags-ticker', array( $this, 'covtags_tricker_world_card_data' ) ); #XX
    ...
    // Ticker Data ( List All Countries By Ticker ) **
    public function covtags_tricker_world_card_data ( $atts ){
      ...
      $default_atts = array(
        'ticker_text'         =>   NULL,
        'ticker_speed'        => 'normal', # normal | fast | medium | slow
        'position'            => 'normal', # normal | top | bottom
        'field'               => 'cases',
        'dark_mode'           => 'no'
      );
      ...
      # Render Options With Ticker Data
