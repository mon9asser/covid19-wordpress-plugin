...
if( !class_exists( 'CovTags_UI' ) ){
  ...
  class CovTags_UI extends CovTags_Request {
    ...
    public function Card_All_countries_tricker ( $attributes ){
      ...
      # Request All Countries From api
      $countries = $this->Countries();
                  ...
                  <!-- Country Title -->
                   <div class="covtags-countryInfo">
                     ...
                     <span class="cov-cases-number">
                       <b>
                         <?php echo apply_filters( 'covtags_si_system_number_units', $country->{$field_atts[0]}, 'format_comma' );?>
                       </b>
                     </span>
      ...
      <script type="text/javascript">
        window.covtagsTickerData({
          _id : <?php echo wp_json_encode( $unique_ticker_id ); ?>
        });
      </script>
      <?php
      return ob_get_clean();
